...
func _ready():
	...
	$VBoxContainer/Button3.pressed.connect(_on_identification_pressed)
...
func _on_identification_pressed():
	get_tree().change_scene_to_file("res://scenes/identification_panel.tscn")
